...
import com.web.config.util.MapObjConvertUtil;
...
public class CmeComAbstractDAO extends SqlSessionDaoSupport{
     ...
     */ 
    public Object convertProc(String queryId, Object parameterObject) throws Exception {
