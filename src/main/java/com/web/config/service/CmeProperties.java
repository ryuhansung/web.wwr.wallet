package com.web.config.service;
...
public class CmeProperties {
  ...
  //프로퍼티값 로드시 에러발생하면 반환되는 에러문자열 
    ...
    + ".." + System.getProperty("file.separator") + ".." + System.getProperty("file.separator")+".." + System.getProperty("file.separator")+"cmeconfig"+System.getProperty("file.separator")+"CmeProps";
    ...
    public static final String SECRET_PROPERTIES_FILE
            = RELATIVE_PATH_PREFIX + System.getProperty("file.separator") + "secret_key.properties";
    ...
    private static void debug(Object obj) {
        if (obj instanceof java.lang.Exception) {
        	LoggerFactory.getLogger(CmeProperties.class).debug("IGNORED: " + ((Exception)obj).getMessage());            
        }
    }

    public static String getSecretProperty(String keyName){
        String value = ERR_CODE;
        value="99";
        FileInputStream fis = null;
        try{
            Properties props = new Properties();
            fis  = new FileInputStream(SECRET_PROPERTIES_FILE);
            props.load(new java.io.BufferedInputStream(fis));
            value = props.getProperty(keyName).trim();
        }catch(Exception e){
            debug(e);
